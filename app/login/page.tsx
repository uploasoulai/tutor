      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8">
        <div className="w-full max-w-[400px] flex flex-col gap-8">
          <div className="flex flex-col gap-2">
            <h1 className="text-[32px] font-semibold text-[#191c1d] tracking-tight">Welcome back</h1>
            <p className="text-[#424750]">Sign in to your CoastalTutor account.</p>
          </div>
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="email" className="text-sm font-semibold text-[#191c1d]">Email Address</label>
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="password" className="text-sm font-semibold text-[#191c1d]">Password</label>
          ...
          <div className="pt-4 border-t border-[#e7e8e9] text-center">
            <p className="text-[#424750]">
              ...
              <button onClick={() => router.push("/signup")} className="text-[#003461] font-semibold hover:underline">
                Create one here
              </button>
            </p>
          </div>
