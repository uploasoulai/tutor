  ...
  return (
    <div className="content-stretch flex flex-col items-start max-w-[512px] relative shrink-0 w-[512px]" data-name="Container">
      <div className="flex flex-col font-['Nimbus_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#424750] text-[16px] whitespace-nowrap">
        ...
        <p className="leading-[24px] mb-0">functions. This module aligns with your upcoming AP exam prep</p>
...
function Button() {
  return (
    <div className="bg-[#003461] content-stretch flex gap-[4px] items-center pb-[13.5px] pt-[12.5px] px-[24px] relative rounded-[8px] shrink-0" data-name="Button">
...
function AiSmartPathHeroComponent() {
  return (
    <div className="bg-white col-[1/span_8] justify-self-stretch relative rounded-[12px] row-1 self-start shrink-0" data-name="AI Smart Path (Hero Component)">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-between pl-[28px] pr-[24px] py-[24px] relative size-full">
          <Container2 />
          <div className="absolute bg-[#d3e4ff] blur-[32px] opacity-30 right-[-64px] rounded-[9999px] size-[256px] top-[-64px]" data-name="Background+Blur" />
          <Margin />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#003461] border-l-4 border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_4px_12px_0px_rgba(0,43,135,0.08)]" />
    </div>
  );
}
...
function Heading3Margin() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] pb-[24px] right-[24px] top-[24px]" data-name="Heading 3:margin">
      <Heading3 />
    </div>
  );
}
...
function Container9() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col items-center left-1/2 pl-[3.55px] pr-[3.56px] top-[calc(50%+92px)]" data-name="Container">
...
function MockCircularProgress() {
  return (
    <div className="content-stretch flex items-center justify-center p-[8px] relative rounded-[9999px] shrink-0 size-[128px]" data-name="Mock Circular Progress">
      <div aria-hidden="true" className="absolute border-8 border-[#edeeef] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <Paragraph />
      <div className="absolute flex inset-[-15.2px_-15.2px_-15.19px_-15.2px] items-center justify-center" style={{ containerType: "size" }}>
        <div className="flex-none h-[hypot(-50cqw,50cqh)] rotate-45 w-[hypot(50cqw,50cqh)]">
          <div className="relative rounded-[9999px] size-full" data-name="Border">
            <div aria-hidden="true" className="absolute border-8 border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[9999px]" />
          </div>
        </div>
      </div>
    </div>
...
function MockCircularProgressMargin() {
  return (
    <div className="absolute content-stretch flex flex-col h-[140px] items-start left-[77.33px] pb-[12px] top-[68px] w-[128px]" data-name="Mock Circular Progress:margin">
...
function DailyGoalTracking() {
  return (
    <div className="bg-white col-[9/span_4] drop-shadow-[0px_4px_6px_rgba(0,43,135,0.08)] h-[280px] justify-self-stretch relative rounded-[12px] row-1 shrink-0" data-name="Daily Goal Tracking">
      <Heading3Margin />
      <Container9 />
...
function Background() {
  return (
    <div className="bg-[#e7e8e9] h-[8px] relative rounded-[9999px] shrink-0 w-full" data-name="Background">
      <div className="absolute bg-[#003461] h-[8px] left-0 right-[18%] rounded-[9999px] top-0" data-name="Background" />
    </div>
  );
}
...
function Math() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Math">
      <Container12 />
      <Background />
    </div>
  );
...
function Background1() {
  return (
    <div className="bg-[#e7e8e9] h-[8px] relative rounded-[9999px] shrink-0 w-full" data-name="Background">
      <div className="absolute bg-[#3b6934] h-[8px] left-0 right-[35%] rounded-[9999px] top-0" data-name="Background" />
    </div>
  );
}
...
function Science() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Science">
      <Container15 />
      <Background1 />
    </div>
  );
...
function Background2() {
  return (
    <div className="bg-[#e7e8e9] h-[8px] relative rounded-[9999px] shrink-0 w-full" data-name="Background">
      <div className="absolute bg-[#793701] h-[8px] left-0 right-[10%] rounded-[9999px] top-0" data-name="Background" />
    </div>
  );
}
...
function Literature() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Literature">
      <Container18 />
      <Background2 />
    </div>
  );
...
function SubjectMasteryProgress() {
  return (
    <div className="bg-white col-[1/span_7] drop-shadow-[0px_4px_6px_rgba(0,43,135,0.08)] justify-self-stretch relative rounded-[12px] row-2 self-start shrink-0" data-name="Subject Mastery Progress">
...
function Background3() {
  return (
    <div className="bg-[#b9eeab] relative rounded-[9999px] shrink-0 size-[40px]" data-name="Background">
...
function Background4() {
  return (
    <div className="bg-[#d3e4ff] relative rounded-[9999px] shrink-0 size-[40px]" data-name="Background">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Container24 />
      </div>
    </div>
...
function UpcomingRecent() {
  return (
    <div className="bg-white col-[8/span_5] drop-shadow-[0px_4px_6px_rgba(0,43,135,0.08)] justify-self-stretch relative rounded-[12px] row-2 self-start shrink-0" data-name="Upcoming & Recent">
...
function BentoGridLayout() {
  return (
    <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(12,minmax(0,1fr))] grid-rows-[__280px_236px] relative shrink-0 w-full" data-name="Bento Grid Layout">
...
function DashboardCanvas() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] inset-[65px_0_189px_0] items-start max-w-[1280px] p-[64px]" data-name="Dashboard Canvas">
      <Container />
      <BentoGridLayout />
    </div>
  );
...
function Container29() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Nimbus_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#424750] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">© 2024 Coastal AI Academy. Aligned with BC Ministry of Education Standards.</p>
      </div>
    </div>
  );
}
...
function Footer() {
  return (
    <div className="absolute bg-[#e1e3e4] bottom-0 content-stretch flex flex-col items-start left-0 pt-px right-0" data-name="Footer">
...
function MainContentWrapper() {
  return (
    <div className="flex-[1_0_0] min-h-[1024px] min-w-px relative self-stretch" data-name="Main Content Wrapper">
      <DashboardCanvas />
      <Footer />
      <HeaderTopNavBar />
    </div>
...
function ItemActiveDashboardLink() {
  return (
    <div className="absolute bg-[rgba(0,75,135,0.1)] content-stretch flex gap-[12px] items-center left-[4px] p-[12px] right-[-4px] rounded-[8px] top-0" data-name="Item - Active: Dashboard → Link">
      <Container39 />
      <Container40 />
    </div>
  );
...
function ItemLink() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-0 p-[12px] right-0 rounded-[8px] top-[60px]" data-name="Item → Link">
      <Container41 />
      <Container42 />
    </div>
  );
...
function ItemLink1() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-0 p-[12px] right-0 rounded-[8px] top-[120px]" data-name="Item → Link">
      <Container43 />
      <Container44 />
    </div>
  );
...
function ItemLink2() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-0 p-[12px] right-0 rounded-[8px] top-[180px]" data-name="Item → Link">
      <Container45 />
      <Container46 />
    </div>
  );
...
function ItemLink3() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-0 p-[12px] right-0 rounded-[8px] top-[240px]" data-name="Item → Link">
      <Container47 />
      <Container48 />
    </div>
  );
...
function Button5() {
  return (
    <div className="bg-[#003461] content-stretch flex gap-[4px] items-center justify-center py-[12px] relative rounded-[8px] shrink-0 w-full" data-name="Button">
      <div className="absolute bg-[rgba(255,255,255,0)] inset-0 rounded-[8px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)]" data-name="Button:shadow" />
      <Container50 />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-center text-white tracking-[0.14px] whitespace-nowrap">
...
function List2() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start pt-[13px] relative shrink-0 w-full" data-name="List">
      <div aria-hidden="true" className="absolute border-[#c2c6d1] border-solid border-t inset-0 pointer-events-none" />
      <ItemLink4 />
      <ItemLink5 />
    </div>
...
function SideNavBarDesktop() {
  return (
    <div className="absolute bg-[#f8f9fa] content-stretch flex flex-col h-[1024px] items-start justify-between left-0 pl-[12px] pr-[13px] py-[24px] top-0 w-[256px]" data-name="SideNavBar (Desktop)">
...
export default function Component() {
  return (
    <div className="content-stretch flex items-start justify-center pl-[256px] relative size-full" style={{ backgroundImage: "linear-gradient(90deg, rgb(248, 249, 250) 0%, rgb(248, 249, 250) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="学生核心仪表盘探索">
      <MainContentWrapper />
      <SideNavBarDesktop />
    </div>
  );
