...
function Background() {
  return (
    <div
      className="bg-[#e1e3e4] content-stretch flex flex-col items-start px-[12px] py-[4px] relative rounded-[9999px] shrink-0"
...
function BackgroundShadow() {
  return (
    <div
      className="bg-[#004b87] content-stretch flex items-center justify-center overflow-clip relative rounded-[9999px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] shrink-0 size-[40px]"
...
function TopAppBarMobileContextDesktopHeader() {
  return (
    <div
      className="bg-white drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] relative shrink-0 w-full z-[2]"
      data-name="Top App Bar (Mobile Context / Desktop Header)"
    >
      <div
        aria-hidden="true"
...
function Container3() {
  return (
    <div
      className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[356.05px]"
      data-name="Container"
    >
      <Heading2 />
      <Container5 />
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Student Profile">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img
          alt=""
          className="absolute h-full left-[-4.86%] max-w-none top-0 w-[109.71%]"
          src={imgStudentProfile.src}
        />
      </div>
    </div>
  );
...
function Background1() {
  return (
    <div
      className="bg-[#e1e3e4] content-stretch flex flex-col h-[48px] items-start justify-center overflow-clip relative rounded-[9999px] shrink-0 w-[43.75px]"
      data-name="Background"
    >
      <StudentProfile />
    </div>
...
function Container10() {
  return (
    <div
      className="content-stretch flex flex-col items-start relative shrink-0 w-[73.17px]"
      data-name="Container"
    >
      <Heading3 />
      <Container11 />
...
function Background2() {
  return (
    <div
      className="bg-[#ffdad6] content-stretch flex flex-col items-start pl-[8px] pr-[27.07px] py-[4px] relative rounded-[4px] shrink-0"
      data-name="Background"
    >
  ...
  return (
    ...
    >
      <div className="flex flex-col font-['Nimbus_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#191c1d] text-[16px] w-full">
        ...
        <p className="mb-0">
          <span className="font-['Nimbus_Sans:Bold',sans-serif] leading-[24px] not-italic text-[#ba1a1a]">
...
function Button() {
  return (
    <div
      className="bg-[#e7e8e9] content-stretch flex flex-[1_0_0] flex-col items-center justify-center min-w-px py-[12px] relative rounded-[8px]"
      data-name="Button"
    >
...
function Button1() {
  return (
    <div
      className="bg-[#003461] content-stretch drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] flex flex-[1_0_0] gap-[4px] items-center justify-center min-w-px py-[12px] relative rounded-[8px]"
      data-name="Button"
    >
      <Container14 />
...
function AlertCard() {
  return (
    <div
      className="bg-[#f8f9fa] col-1 drop-shadow-[0px_4px_6px_rgba(0,43,135,0.08)] justify-self-stretch relative rounded-[12px] row-1 self-start shrink-0"
      data-name="Alert Card 1"
    >
      <div
        aria-hidden="true"
        className="absolute border-[#ba1a1a] border-solid border-t-4 inset-0 pointer-events-none rounded-[12px]"
      />
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Student Profile">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img
          alt=""
          className="absolute h-full left-[-9.7%] max-w-none top-0 w-[119.4%]"
          src={imgStudentProfile1.src}
        />
      </div>
    </div>
  );
...
function Background3() {
  return (
    <div
      className="bg-[#e1e3e4] content-stretch flex flex-col h-[48px] items-start justify-center overflow-clip relative rounded-[9999px] shrink-0 w-[40.2px]"
      data-name="Background"
    >
      <StudentProfile1 />
    </div>
...
function Container18() {
  return (
    <div
      className="content-stretch flex flex-col items-start relative shrink-0 w-[79.2px]"
      data-name="Container"
    >
      <Heading4 />
      <Container19 />
...
function Container17() {
  return (
    <div
      className="content-stretch flex gap-[12px] items-center mr-[-0.01px] relative shrink-0"
      data-name="Container"
    >
      <Background3 />
      <Container18 />
...
function Background4() {
  return (
    <div
      className="bg-[#793701] content-stretch flex flex-col items-start px-[8px] py-[4px] relative rounded-[4px] shrink-0"
      data-name="Background"
    >
...
function AlertCard1() {
  return (
    <div
      className="bg-[#f8f9fa] col-2 drop-shadow-[0px_4px_6px_rgba(0,43,135,0.08)] justify-self-stretch relative rounded-[12px] row-1 self-start shrink-0"
      data-name="Alert Card 2"
    >
      <div
        aria-hidden="true"
        className="absolute border-[#572500] border-solid border-t-4 inset-0 pointer-events-none rounded-[12px]"
      />
      <div className="content-stretch flex flex-col items-start justify-between pb-[24px] pt-[28px] px-[24px] relative size-full">
        <Container15 />
        <Button2 />
...
function Container6() {
  return (
    <div
      className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(3,minmax(0,1fr))] grid-rows-[_258px] relative shrink-0 w-full"
      data-name="Container"
    >
      <AlertCard />
      <AlertCard1 />
...
function SectionAtRiskAlertsBentoGrid() {
  return (
    <div
      ...
      data-name="Section - At-Risk Alerts Bento Grid"
    >
      <Container2 />
      <Container6 />
    </div>
...
function Container23() {
  return (
    <div
      className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[344.41px]"
      data-name="Container"
    >
      <Heading5 />
      <Container24 />
  ...
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[8px] relative size-full">
        <div
          className="bg-[#3b6934] relative rounded-[9999px] shrink-0 size-[12px]"
          data-name="Background"
        />
        <Container26 />
      </div>
  ...
  return (
    <div className="relative shrink-0" data-name="VerticalBorder">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center pl-[9px] pr-[8px] relative size-full">
        <div
          className="bg-[#793701] relative rounded-[9999px] shrink-0 size-[12px]"
          data-name="Background"
        />
        <Container27 />
      </div>
...
function VerticalBorder1() {
  return (
    <div className="relative shrink-0" data-name="VerticalBorder">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center pl-[9px] pr-[8px] relative size-full">
        <div
          className="bg-[#ba1a1a] relative rounded-[9999px] shrink-0 size-[12px]"
          data-name="Background"
        />
        <Container28 />
      </div>
...
function BackgroundBorder() {
  return (
    <div
      className="bg-[#f3f4f5] content-stretch flex gap-[12px] items-center p-[5px] relative rounded-[8px] shrink-0"
...
function Container29() {
  return (
    <div
      className="col-[1/span_2] justify-self-stretch relative row-1 self-start shrink-0"
      data-name="Container"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
...
function Container30() {
  return (
    <div
      className="col-3 justify-self-stretch relative row-1 self-start shrink-0"
      data-name="Container"
    >
...
function Container31() {
  return (
    <div
      className="col-4 justify-self-stretch relative row-1 self-start shrink-0"
      data-name="Container"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#424750] text-[14px] text-center tracking-[0.14px] whitespace-nowrap">
...
function Container32() {
  return (
    <div
      className="col-5 justify-self-stretch relative row-1 self-start shrink-0"
      data-name="Container"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#424750] text-[14px] text-center tracking-[0.14px] whitespace-nowrap">
...
function HeaderRow() {
  return (
    <div
      className="absolute gap-x-[12px] gap-y-[12px] grid grid-cols-[repeat(5,minmax(0,1fr))] grid-rows-[_20px] left-0 pb-[13px] right-0 top-0"
...
function Container33() {
  return (
    <div
      className="col-[1/span_2] justify-self-stretch relative row-1 self-center shrink-0"
      data-name="Container"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
...
function Background5() {
  return (
    <div
      className="bg-[#3b6934] col-3 h-[32px] justify-self-stretch relative rounded-[4px] row-1 self-center shrink-0"
      data-name="Background"
    >
...
function Background6() {
  return (
    <div
      className="bg-[#a1d494] col-4 h-[32px] justify-self-stretch relative rounded-[4px] row-1 self-center shrink-0"
      data-name="Background"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
...
function Background7() {
  return (
    <div
      className="bg-[#3b6934] col-5 h-[32px] justify-self-stretch relative rounded-[4px] row-1 self-center shrink-0"
      data-name="Background"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">
...
function Row() {
  return (
    <div
      className="absolute gap-x-[12px] gap-y-[12px] grid grid-cols-[repeat(5,minmax(0,1fr))] grid-rows-[_32px] left-0 pb-[13px] pt-[12px] right-0 top-[45px]"
      data-name="Row 1"
    >
      <div
        aria-hidden="true"
...
function Background8() {
  return (
    <div
      className="bg-[#ba1a1a] col-3 h-[32px] justify-self-stretch relative rounded-[4px] row-1 self-center shrink-0"
      data-name="Background"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">
...
function Background9() {
  return (
    <div
      className="bg-[#ffdad6] col-4 h-[32px] justify-self-stretch relative rounded-[4px] row-1 self-center shrink-0"
      data-name="Background"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
...
function Background10() {
  return (
    <div
      className="bg-[#793701] col-5 h-[32px] justify-self-stretch relative rounded-[4px] row-1 self-center shrink-0"
      data-name="Background"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
...
function Row1() {
  return (
    <div
      className="absolute gap-x-[12px] gap-y-[12px] grid grid-cols-[repeat(5,minmax(0,1fr))] grid-rows-[_32px] left-0 pb-[13px] pt-[12px] right-0 top-[102px]"
      data-name="Row 2"
    >
      <div
        aria-hidden="true"
...
function Container35() {
  return (
    <div
      className="col-[1/span_2] content-stretch flex flex-col items-start justify-self-stretch relative row-1 self-center shrink-0"
      data-name="Container"
    >
      <div className="flex flex-col font-['Nimbus_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#191c1d] text-[16px] whitespace-nowrap">
...
function Background11() {
  return (
    <div
      className="bg-[#793701] col-3 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative rounded-[4px] row-1 self-center shrink-0"
      data-name="Background"
    >
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#ffa46a] text-[16px] text-center whitespace-nowrap">
...
function Background12() {
  return (
    <div
      className="bg-[#572500] col-4 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative rounded-[4px] row-1 self-center shrink-0"
      data-name="Background"
    >
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">
...
function Background13() {
  return (
    <div
      className="bg-[#b9eeab] col-5 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative rounded-[4px] row-1 self-center shrink-0"
      data-name="Background"
    >
...
function Row2() {
  return (
    <div
      className="absolute gap-x-[12px] gap-y-[12px] grid grid-cols-[repeat(5,minmax(0,1fr))] grid-rows-[_32px] left-0 py-[12px] right-0 top-[159px]"
      data-name="Row 3"
    >
      <Container35 />
      <Background11 />
...
function SectionLearningGapHeatmapBcCurriculum() {
  return (
    <div
      className="bg-[#f8f9fa] drop-shadow-[0px_4px_6px_rgba(0,43,135,0.08)] relative rounded-[12px] shrink-0 w-full"
      data-name="Section - Learning Gap Heatmap (BC Curriculum)"
    >
      <div
        aria-hidden="true"
...
function Container39() {
  return (
    <div
      className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip pb-[2px] pt-px relative"
      data-name="Container"
    >
...
function Input() {
  return (
    <div
      className="bg-[#edeeef] content-stretch flex items-start justify-center overflow-clip pb-[14px] pl-[80px] pr-[12px] pt-[15px] relative rounded-[9999px] shrink-0 w-[256px]"
      data-name="Input"
    >
      <Container39 />
    </div>
...
function Container40() {
  return (
    <div
      className="absolute bottom-1/4 content-stretch flex flex-col items-start left-[12px] top-1/4"
      data-name="Container"
    >
...
function HeaderRow1() {
  return (
    <div
      className="bg-white content-stretch flex items-start justify-center mb-[-1px] pb-px relative shrink-0 w-full"
      data-name="Header → Row"
    >
      <div
        aria-hidden="true"
...
function Background14() {
  return (
    <div
      className="bg-[#004b87] content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[32px]"
      data-name="Background"
    >
...
function Data() {
  return (
    <div
      className="absolute content-stretch flex gap-[12px] items-center left-[24px] right-[592.62px] top-[12.5px]"
      data-name="Data"
    >
      <Background14 />
      <Container41 />
...
function Background15() {
  return (
    <div
      className="bg-[#b9eeab] content-stretch flex items-start px-[8px] py-[4px] relative rounded-[4px] shrink-0"
      data-name="Background"
    >
...
function Data1() {
  return (
    <div
      className="absolute content-stretch flex flex-col items-start left-[327.38px] px-[24px] py-[14.5px] right-[351.49px] top-0"
      data-name="Data"
    >
      <Background15 />
    </div>
...
function Data2() {
  return (
    <div
      className="absolute content-stretch flex gap-[4px] items-center left-[544.5px] px-[24px] py-[12.5px] right-[149.53px] top-[0.5px]"
      data-name="Data"
    >
      <Container42 />
...
function Button3() {
  return (
    <div
      className="content-stretch flex items-center justify-center p-[4px] relative shrink-0"
      data-name="Button"
    >
      <Container43 />
    </div>
...
function Data3() {
  return (
    <div
      className="absolute content-stretch flex flex-col items-end left-[746.47px] px-[24px] py-[12.5px] right-0 top-0"
      data-name="Data"
    >
      <Button3 />
    </div>
...
function MayaLin() {
  return (
    <div
      className="max-w-[279.3800048828125px] relative rounded-[9999px] shrink-0 size-[32px]"
      data-name="Maya Lin"
    >
...
function Data4() {
  return (
    <div
      className="absolute content-stretch flex gap-[12px] items-center left-[24px] right-[592.62px] top-[30px]"
      data-name="Data"
    >
      <MayaLin />
      <Container44 />
...
function Background16() {
  return (
    <div
      className="bg-[#ffdad6] content-stretch flex items-start px-[8px] py-[4px] relative rounded-[4px] shrink-0"
      data-name="Background"
    >
...
function Data5() {
  return (
    <div
      className="absolute content-stretch flex flex-col items-start left-[327.38px] px-[24px] py-[32px] right-[351.49px] top-0"
      data-name="Data"
    >
      <Background16 />
    </div>
...
function Button4() {
  return (
    <div
      className="bg-[#003461] content-stretch drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] flex flex-col items-center justify-center px-[12px] py-[4px] relative rounded-[4px] shrink-0"
      data-name="Button"
    >
...
function Data7() {
  return (
    <div
      className="absolute content-stretch flex items-start justify-end left-[544.5px] px-[24px] py-[12px] right-[149.53px] top-[43.5px]"
      data-name="Data"
    >
      <Button4 />
    </div>
...
function StudentRow2AtRisk() {
  return (
    <div
      className="bg-[rgba(255,218,214,0.2)] h-[92px] relative shrink-0 w-full"
      data-name="Student Row 2 (At Risk)"
    >
      <div
        aria-hidden="true"
        className="absolute border-[#c2c6d1] border-b border-solid inset-0 pointer-events-none"
...
function Background17() {
  return (
    <div
      className="bg-[#793701] content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[32px]"
      data-name="Background"
    >
...
function Background18() {
  return (
    <div
      className="bg-[#e7e8e9] content-stretch flex items-start px-[8px] py-[4px] relative rounded-[4px] shrink-0"
      data-name="Background"
    >
...
function Data9() {
  return (
    <div
      className="absolute content-stretch flex flex-col items-start left-[327.38px] pb-[14px] pt-[14.5px] px-[24px] right-[351.49px] top-0"
      data-name="Data"
    >
      <Background18 />
    </div>
...
function Data11() {
  return (
    <div
      className="absolute content-stretch flex flex-col items-end left-[746.47px] px-[24px] py-[12px] right-0 top-0"
      data-name="Data"
    >
      <Button5 />
    </div>
...
function SectionClassWideProgressOverview() {
  return (
    <div
      className="bg-[#f8f9fa] relative rounded-[12px] shrink-0 w-full"
      data-name="Section - Class-wide Progress Overview"
    >
      ...
      <div
        aria-hidden="true"
        className="absolute border-[#3b6934] border-solid border-t-4 inset-0 pointer-events-none rounded-[12px] shadow-[0px_4px_12px_0px_rgba(0,43,135,0.08)]"
      />
    </div>
  );
}
...
function Container1() {
  return (
    <div
      className="flex-[1_0_0] max-w-[1280px] min-h-px relative w-full z-[1]"
      data-name="Container"
    >
...
function MainContentCanvas() {
  return (
    <div
      className="flex-[1_0_0] min-h-[1386px] min-w-px relative self-stretch"
...
function LinkActiveTabDashboard() {
  return (
    <div
      className="bg-[rgba(0,75,135,0.1)] relative rounded-[8px] shrink-0 w-full"
...
function Button6() {
  return (
    <div
      className="bg-[#003461] drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] relative rounded-[9999px] shrink-0 w-full"
      data-name="Button"
    >
...
function DesktopSideNavigationFromJson() {
  return (
    <div
      className="absolute bg-[#f8f9fa] content-stretch flex flex-col h-[1386px] items-start justify-between left-0 pl-[12px] pr-[13px] py-[24px] top-0 w-[256px]"
      data-name="Desktop Side Navigation (from JSON)"
    >
      <div
        aria-hidden="true"
      ...
      />
      <div
        className="absolute bg-[rgba(255,255,255,0)] h-[1386px] left-0 shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] top-0 w-[256px]"
        data-name="Desktop Side Navigation (from JSON):shadow"
      />
      <Margin />
      <Container52 />
      <HorizontalBorder1 />
