...
function Container1() {
  return (
    <div className="h-[27.5px] relative shrink-0 w-[25px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25 27.5">
        <g id="Container">
...
function GlobalNavSuppressedForLinearFlowMinimalLogoHeaderInstead() {
  return (
    <div className="content-stretch flex items-center justify-between max-w-[800px] relative shrink-0 w-full" data-name="Global Nav Suppressed for Linear Flow. Minimal Logo Header instead">
      <Container />
      <Button />
    </div>
  );
...
function GlobalNavSuppressedForLinearFlowMinimalLogoHeaderInsteadMargin() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[800px] pb-[48px] relative shrink-0 w-[800px]" data-name="Global Nav Suppressed for Linear Flow. Minimal Logo Header instead:margin">
...
function ProgressBar() {
  return (
    <div className="bg-[#e1e3e4] h-[8px] overflow-clip relative rounded-[9999px] shrink-0 w-full" data-name="Progress Bar">
      <div className="absolute bg-[#003461] bottom-0 left-0 right-1/2 rounded-[9999px] top-0" data-name="Background" />
    </div>
  );
}
...
function ProgressBarMargin() {
  return (
    <div className="content-stretch flex flex-col h-[20px] items-start pb-[12px] relative shrink-0 w-full" data-name="Progress Bar:margin">
      <ProgressBar />
    </div>
  );
}
...
function Background() {
  return (
    <div className="bg-[#b9eeab] content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[40px]" data-name="Background">
      <Container4 />
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[176.73px]" data-name="Container">
      <Heading1 />
      <Container6 />
    </div>
  );
...
function Step1CompletedStateCollapsed() {
  return (
    <div className="bg-white drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] opacity-80 relative rounded-[12px] shrink-0 w-full" data-name="STEP 1: Completed State (Collapsed)">
...
function Background1() {
  return (
    <div className="bg-[#003461] content-stretch flex items-center justify-center pb-[6.5px] pt-[5.5px] relative rounded-[9999px] shrink-0 size-[40px]" data-name="Background">
...
function LabelSubjectCardSelected() {
  return (
    <div className="bg-[rgba(0,75,135,0.05)] col-1 justify-self-stretch relative rounded-[12px] row-1 self-start shrink-0" data-name="Label - Subject Card (Selected)">
      <div aria-hidden="true" className="absolute border-2 border-[#003461] border-solid inset-0 pointer-events-none rounded-[12px]" />
...
function Background3() {
  return (
    <div className="h-[42px] relative shrink-0 w-[42.057px]" data-name="Background">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42.057 42">
        <g id="Background">
...
function LabelSubjectCardUnselected() {
  return (
    <div className="bg-[#f8f9fa] col-2 justify-self-stretch relative rounded-[12px] row-1 self-start shrink-0" data-name="Label - Subject Card (Unselected)">
      <div aria-hidden="true" className="absolute border-2 border-[#c2c6d1] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="content-stretch flex flex-col gap-[4px] items-start p-[26px] relative size-full">
        <Container12 />
        <Heading3 />
        <Container13 />
...
function LabelSubjectCardUnselected1() {
  return (
    <div className="bg-[#f8f9fa] col-3 justify-self-stretch relative rounded-[12px] row-1 self-start shrink-0" data-name="Label - Subject Card (Unselected)">
      <div aria-hidden="true" className="absolute border-2 border-[#c2c6d1] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="content-stretch flex flex-col gap-[4px] items-start p-[26px] relative size-full">
        <Container14 />
        <Heading4 />
...
function Background5() {
  return (
    <div className="h-[43px] relative shrink-0 w-[38px]" data-name="Background">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38 43">
        <g id="Background">
...
function Margin() {
  return (
    <div className="h-[36px] relative shrink-0 w-[20px]" data-name="Margin">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 36">
        <g id="Margin">
          <g id="Icon" />
        </g>
      </svg>
...
function Background6() {
  return (
    <div className="absolute bg-[#3b6934] right-[2.02px] rounded-bl-[8px] top-[2px]" data-name="Background">
...
function LabelSubjectCardUnselectedAp() {
  return (
    <div className="bg-[#f8f9fa] col-1 justify-self-stretch relative rounded-[12px] row-2 self-start shrink-0" data-name="Label - Subject Card (Unselected - AP)">
...
function LabelSubjectCardSelected1() {
  return (
    <div className="bg-[rgba(0,75,135,0.05)] col-2 justify-self-stretch relative rounded-[12px] row-2 self-start shrink-0" data-name="Label - Subject Card (Selected)">
      <div aria-hidden="true" className="absolute border-2 border-[#003461] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="content-stretch flex flex-col gap-[4px] items-start p-[26px] relative size-full">
        <Container18 />
        <Heading6 />
...
function Step2ActiveStateExpanded() {
  return (
    <div className="bg-white drop-shadow-[0px_4px_6px_rgba(0,43,135,0.08)] relative rounded-[12px] shrink-0 w-full" data-name="STEP 2: Active State (Expanded)">
...
function Background8() {
  return (
    <div className="bg-[#e1e3e4] relative rounded-[9999px] shrink-0 size-[40px]" data-name="Background">
...
function Step3UpcomingStateCollapsed() {
  return (
    <div className="bg-[#f8f9fa] opacity-60 relative rounded-[12px] shrink-0 w-full" data-name="STEP 3: Upcoming State (Collapsed)">
      <div aria-hidden="true" className="absolute border border-[#c2c6d1] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
...
function Step4UpcomingStateCollapsed() {
  return (
    <div className="bg-[#f8f9fa] opacity-60 relative rounded-[12px] shrink-0 w-full" data-name="STEP 4: Upcoming State (Collapsed)">
      <div aria-hidden="true" className="absolute border border-[#c2c6d1] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center p-[25px] relative size-full">
          <Background9 />
...
function MainWizardContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start max-w-[800px] relative shrink-0 w-[800px]" data-name="Main Wizard Container">
      <ProgressBarMargin />
...
export default function Component() {
  return (
    <div className="content-stretch flex flex-col items-center pb-[86px] pt-[48px] px-[64px] relative size-full" style={{ backgroundImage: "linear-gradient(90deg, rgb(243, 244, 245) 0%, rgb(243, 244, 245) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="学生入职引导">
